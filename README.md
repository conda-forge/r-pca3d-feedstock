...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3424&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pca3d-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pca3d` can be installed with `conda`:
...
```
mamba install r-pca3d
```

It is possible to list all of the versions of `r-pca3d` available on your platform with `conda`:
...
```
mamba search r-pca3d --channel conda-forge
```
...
mamba repoquery search r-pca3d --channel conda-forge

# List packages depending on `r-pca3d`:
mamba repoquery whoneeds r-pca3d --channel conda-forge

# List dependencies of `r-pca3d`:
mamba repoquery depends r-pca3d --channel conda-forge
```
